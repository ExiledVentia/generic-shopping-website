...
<body class="bg-gray-100 dark:bg-gray-900">
    ...
    <div class="p-8 sm:ml-64">
        <h1 class="text-3xl font-bold mb-4 text-black dark:text-white">Edit Category</h1>
        <?php
        ...
        <div class="pt-5">
            ...
            <input type="text" name="name" value="<?= $k->category_name ?>" id="base-input" placeholder="Category Name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <div class="pt-5 w-5">
