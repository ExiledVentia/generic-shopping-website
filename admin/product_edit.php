...
<body class="bg-gray-100 dark:bg-gray-900">
    ...
    <div class="p-8 sm:ml-64">
        <h1 class="text-3xl font-bold mb-4 text-black dark:text-white">Edit Product</h1>
        <?php
        ...
        <div class="pt-5">
            ...
            <input type="text" value="<?php echo $p->product_name; ?>" name="name" id="base-input" placeholder="Product Name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <div class="pt-5">
            <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Price</label>
            <input type="text" value="<?php echo $p->product_price; ?>" name="price" id="base-input" placeholder="Rp.XXX XXX" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <div class="pt-5">
            <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
            <textarea id="description" name="desc" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Description..."><?php echo $p->product_description; ?></textarea>
        </div>
        <div class="pt-5">
            <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Stock</label>
            <input type="text" value="<?php echo $p->stock; ?>" name="stock" id="base-input" placeholder="Stock" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <div class="pt-5">
            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="image">Upload Image File</label>
            <input type="hidden" name="alt_img" value="<?php echo $p->product_image ?>">
        ...
        <?php
                if (isset($_POST['submit'])) {
                    ...
                    if ($update) {
                        ...
                        echo 'Edit Product Failed ' . mysqli_error($conn);
                    }
                }
                ?>
    </div>
